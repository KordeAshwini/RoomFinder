...
const Signin = ({ onClose, onSwitchToSignup, onForgotPassword, onLoginSuccess, onSwitchToSignupAsTenant, onSwitchToSignupAsOwner }) => {
  const [show, setShow] = useState(false);
  const [loading, setLoading] = useState(false);
      ...
      >
        ...
        <div className="mt-4 text-center text-sm text-gray-600">
          ...
          <div className="mt-2">
              ...
              <button
                  onClick={onSwitchToSignupAsTenant}
                  className="text-orange-500 hover:underline focus:outline-none mr-2"
              >
                  Sign up as Tenant
              </button>
              <span className="mr-2">|</span>
              <button
                  onClick={onSwitchToSignupAsOwner}
                  className="text-orange-500 hover:underline focus:outline-none mr-2"
              >
                  Sign up as Owner
              </button>
